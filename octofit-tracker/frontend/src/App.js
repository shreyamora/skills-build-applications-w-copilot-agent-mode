          ...
          <Route path="/" element={
            <div className="text-center mt-5">
              ...
              <div className="d-flex justify-content-center gap-3 mt-4">
                <Link className="btn btn-outline-light btn-lg" to="/activities">View Activities</Link>
                <Link className="btn btn-outline-light btn-lg" to="/leaderboard">Leaderboard</Link>
              </div>
            </div>
          } />
        </Routes>
